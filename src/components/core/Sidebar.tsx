...
export const shellNavItems: ShellNavItem[] = [
  ...
  { label: "Anayasal Süreç", shortLabel: "Zaman", href: "/timeline", icon: CalendarClock, group: "Öğrenme", description: "Olayları akışta gör", iconColorClass: "text-amber-600 dark:text-amber-400", iconBgClass: "bg-amber-500/10 dark:bg-amber-500/15" },
        ...
        <Link href="/dashboard" onClick={onNavigate} className="group flex min-w-0 items-center gap-3">
          ...
          {!collapsed || mobile ? (
            <span className="min-w-0 leading-tight">
              ...
              <span className="block truncate text-[11px] font-bold text-[var(--sb-text-muted)]">KPSS Vatandaşlık çalışma sistemi</span>
            </span>
          ) : null}
        </Link>
        {!mobile ? (
