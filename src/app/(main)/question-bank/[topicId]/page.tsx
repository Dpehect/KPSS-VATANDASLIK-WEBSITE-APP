...
export async function generateMetadata({ params, searchParams }: PageProps): Promise<Metadata> {
  ...
  const title = selectedTest?.title ?? (topic ? `${topic.title} Testleri` : "Karma KPSS Vatandaşlık Testleri");
  return {
    title,
    description: `${title} için Supabase'de hazır bekleyen açıklamalı KPSS Vatandaşlık testleri, seviye seçimi ve soru çözüm oturumu.`,
  };
}
