...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${topic.title} | KPSS Vatandaşlık Konu Anlatımı`,
    description: `${topic.title} için Supabase'de hazır tutulan derin konu anlatımı, anahtar kavramlar, sık hata analizi ve açıklamalı KPSS Vatandaşlık testleri.`,
  };
}
