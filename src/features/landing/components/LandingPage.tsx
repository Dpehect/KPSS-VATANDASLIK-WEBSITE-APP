    ...
    <main className="min-h-screen overflow-hidden">
      <section className="content-shell relative grid min-h-screen items-center gap-12 py-16 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="relative z-10">
          <p className="kicker">KPSS Vatandaşlık Akademi</p>
          <h1 className="editorial-title mt-5 max-w-5xl text-5xl md:text-7xl xl:text-8xl">
            Vatandaşlığı ezber listesi değil, çalışma sistemi olarak ele al.
          </h1>
          ...
          <div className="page-noise rounded-xl border border-black/[0.08] bg-[white]/82 p-6 shadow-[0_34px_120px_rgba(18,24,38,0.14)] md:p-8">
            <div className="flex items-start justify-between gap-6 border-b border-black/[0.08] pb-6">
              <div>
                ...
                <h2 className="mt-3 text-4xl font-semibold tracking-tight">KPSS Vatandaşlık dosyası</h2>
              </div>
