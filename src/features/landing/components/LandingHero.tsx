      ...
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-7xl items-center gap-10 lg:grid-cols-[1.02fr_0.98fr]">
        <div className="relative z-10 pt-20 lg:pt-0">
          ...
          >
            ...
            KPSS Vatandaşlık için görsel hafıza odaklı çalışma deneyimi
          </div>
          ...
          >
            Parşömen dokusu, zaman tozu, sinematik scroll geçişleri ve WebGL sahneleriyle KPSS Vatandaşlık konularını daha akılda kalıcı, daha canlı ve daha düzenli hale getiren yeni nesil çalışma platformu.
          </p>
