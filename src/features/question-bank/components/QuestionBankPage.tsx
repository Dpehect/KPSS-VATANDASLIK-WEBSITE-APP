...
const levelDescriptions = {
  ...
  zor: "Anayasal Süreç, çeldirici, yorum ve sık karıştırılan ayrımları hedefler.",
} as const;
    ...
    <main className="space-y-8">
      <section className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-white via-blue-50 to-amber-50 p-6 shadow-sm dark:border-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-blue-950 md:p-8">
        <div className="relative z-10 max-w-4xl space-y-4">
          <p className="text-xs font-black uppercase tracking-[0.22em] text-amber-700 dark:text-amber-300">Geniş Kapsamlı Soru Bankası</p>
          ...
          <p className="text-base leading-8 text-slate-700 dark:text-slate-300">Sistemdeki tüm sorular, alanında uzman eğitimciler tarafından güncel müfredata uygun olarak hazırlanmış ve kalite kontrolünden geçmiştir.</p>
