      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          text:
            response.ok && reply
              ? reply
              : "Şu an kısa bir bağlantı gecikmesi var. Sorunu farklı kelimelerle tekrar yaz; KPSS Vatandaşlık açısından en net şekilde açıklayayım.",
        },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: "bot",
          error: true,
          text: "Bağlantı kısa süreli kesildi. Sorunu tekrar gönder; konu, anayasal süreç ve soru havuzunu dikkate alarak açıklayacağım.",
        },
      ]);
    } finally {
      setLoading(false);
  ...
  return (
    <>
      <motion.button
        ...
        aria-label="KPSS Vatandaşlık Rehberi"
      ...
      <AnimatePresence>
        {open ? (
          <motion.section
            ...
            role="dialog"
            aria-label="KPSS Vatandaşlık Rehberi sohbet paneli"
          >
            ...
            <div className="border-t border-slate-200 bg-white p-3">
              ...
              <form onSubmit={handleSubmit} className="flex items-end gap-2 rounded-[22px] border border-slate-200 bg-slate-50 p-2 shadow-inner focus-within:border-blue-400 focus-within:ring-4 focus-within:ring-blue-500/10">
                <textarea
                  ...
                  placeholder="Vatandaşlık sorunu yaz: örn. Put kırıcı kimdir?"
                  disabled={loading}
                  rows={1}
