        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-[#667085]">KPSS Vatandaşlık</p>
            </div>
          </div>
          ...
          <p className="mt-5 max-w-xl text-sm font-bold leading-7 text-[#475467]">
            KPSS Vatandaşlık hazırlık sürecinizi tek bir merkezden yönetin. İlerlemenizi güvenle saklayın, eksiklerinizi analiz edin ve hedeflerinize odaklanın.
          </p>
