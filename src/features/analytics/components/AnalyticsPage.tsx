  ...
  const feedbackData = useMemo(() => {
    ...
    if (answered === 0) {
      return {
        ...
        tip: "Öneri: Temel Hukuk Bilgisi kolay testini çözerek başlayın."
      };
    }
    ...
    if (accuracy >= 85) {
      return {
        ...
        body: `Vatandaşlık sorularında %${accuracy} doğruluk oranına sahipsiniz. Bu oran sınav standartlarının oldukça üzerinde! Bilgilerinizi taze tutmak için karma testlere ve süre sınırına dayalı deneme sınavlarına ağırlık verebilirsiniz.`,
