...
function buildExamPattern(title: string) {
  return [
    ...
    { title: "Anayasal Süreç ayrımı", body: "Benzer olaylar arasında önce-sonra ilişkisini kurmak özellikle antlaşma, kongre, savaş ve inkılap sorularında belirleyicidir." },
  ];
}
