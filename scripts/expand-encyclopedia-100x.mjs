...
export const islamiyetOncesiData: EncyclopediaEntry[] = [
  {
    ...
    "detailedExplanation": "Toplumsal hayatı düzenleyen din, ahlak ve görgü kurallarının yaptırımları manevi iken, hukuk kurallarının yaptırımı devlet gücüne dayalı maddi yaptırımdır. Maddi yaptırım (müeyyide), hukuk kuralına aykırı davranıldığında devlet organları eliyle uygulanan cebirdir. Başlıca yaptırım türleri şunlardır:\\n\\n1. Ceza: Kanunun suç işleyen kişilere uygulanmasını öngördüğü yaptırımdır. Türk Ceza Kanunu'na göre hapis cezaları (ağırlaştırılmış müebbet, müebbet, süreli hapis) ve adli para cezaları olmak üzere ikiye ayrılır. Ayrıca hapis cezaları da kendi içinde kısa süreli (1 yıl veya daha az) ve uzun süreli olarak ayrılmaktadır.\\n\\n2. Cebri İcra: Hukuki yükümlülüklerini kendi rızasıyla yerine getirmeyen kişilerin devlet gücü (icra müdürlükleri) vasıtasıyla bu borçlarını yerine getirmeye zorlanmasıdır (örn: borcunu ödemeyenin mallarının haczedilmesi, kiracının evden tahliye edilmesi, mahkeme kararına rağmen teslim edilmeyen çocuğun icra yoluyla teslim alınması).\\n\\n3. Tazminat: Hukuka aykırı olarak başkasına verilen zararın giderilmesi yaptırımıdır. Maddi tazminat (fiili zarar ve yoksun kalınan karı karşılar) ve manevi tazminat (duyulan acı, elem ve kederi hafifletmek için ödenen para) olarak ayrılır. Tazminat borcunun doğabilmesi için hukuka aykırı bir fiil, zarar, kusur ve nedensellik (illiyet) bağı bulunmalıdır.\\n\\n4. İptal: İdari makamların hukuka aykırı işlemlerinin, yargı organları (idare mahkemeleri) tarafından ortadan kaldırılması, geçmişe etkili olarak geçersiz kılınmasıdır (örn: hukuka aykırı memuriyetten çıkarma kararının mahkemece iptali, imar izninin iptali).\\n\\n5. Hükümsüzlük (Geçersizlik): Hukuki işlemlerin kanunun aradığı geçerlilik şartlarını taşımaması durumunda ortaya çıkan yaptırımdır. Kendi içinde alt türlere ayrılır:\\n  - Yokluk: İşlemin kurucu unsurlarından birinin eksik olmasıdır. Hukuken hiç doğmamış kabul edilir. Herkes tarafından her zaman ileri sürülebilir (örn: resmi nikah memuru önünde yapılmayan evlilik, imzasız sözleşmeler).\\n  - Mutlak Butlan: Kurucu unsurları tam olan ancak kanunun emredici hükümlerine, ahlaka, kamu düzenine aykırı olan veya konusu imkansız olan işlemlerdir. Hakim bunu re'sen (kendiliğinden) dikkate alır (örn: yakın akrabaların evlenmesi, uyuşturucu ticareti veya kiralık katil sözleşmesi).\\n  - Nispi Butlan (İptal edilebilirlik): Kurucu unsurları tam olan ancak işlemi yapan kişinin iradesinin sakatlanmış olmasıdır (hata, hile, tehdit/ikrah). İşlem iptal edilene kadar geçerlidir, iradesi sakatlanan kişi süresi içinde (hata veya hilenin öğrenilmesinden, korkunun etkisinin geçmesinden itibaren 1 yıl içinde) iptal etmezse tamamen geçerli hale gelir.\\n  - Tek Taraflı Bağlamazlık (Askıda Geçersizlik): Velayet veya vesayet altındaki küçüklerin ya da kısıtlıların, yasal temsilcilerinin izni olmadan kendi başlarına yaptıkları borçlandırıcı işlemlerdir. Yasal temsilci onay (icazet) verene kadar işlem askıdadır ve temsilciyi bağlamaz.",
    "keyFacts": [
      ...
      "Nispi butlanda iradesi sakatlanan taraf kanuni süre içinde (1 yıl) işlemi iptal etmezse işlem baştan itibaren geçerli sayılır.",
  ...
  },
  {
    ...
    "keyFacts": [
      ...
      "Medeni Hukuk aile, eşya, miras ve kişiler hukuku olmak üzere 4 ana bölümden oluşur; Borçlar Hukuku Medeni Kanunun 5. kitabıdır.",
  ...
  {
    "id": "kisiler-hukuku-tuzel-gercek",
    "category": "Temel Hukuk Bilgisi",
    "title": "Kişiler Hukuku ve Dernekler/Vakıflar",
    "aliases": [
      "gercek kisiler", "tuzel kisiler", "gaiplik", "olum karinesi", "gaiplik sureleri", "dernekler", "vakiflar"
    ],
    "keywords": [
      "gaiplik", "tüzel", "gerçek", "dernek", "vakıf", "karine", "ölüm"
    ],
    "shortDefinition": "Kişilik kavramının başlangıcı, sona ermesi, ölüm karinesi, gaiplik süreleri ile dernek ve vakıf tüzel kişiliklerinin temel kurallarıdır.",
    "detailedExplanation": "Kişiler Hukuku, Medeni Hukuk'un hak sahibi olabilecek varlıkları (kişileri) ve onların durumlarını inceleyen dalıdır. Hukuken gerçek kişiler (insanlar) ve tüzel kişiler (belirli bir amacı gerçekleştirmek üzere bağımsız bir varlık halinde örgütlenmiş kişi veya mal toplulukları) olmak üzere iki tür kişi vardır.\\n\\nGerçek Kişiliğin Başlangıcı ve Sona Ermesi:\\n- Başlangıç: Gerçek kişilik, çocuğun sağ ve tam olarak doğmasıyla başlar. Sağ doğmak, çocuğun anne bedeninden ayrıldıktan sonra bir an dahi olsa bağımsız yaşam belirtisi göstermektedir.\\n- Sona Erme: Gerçek kişilik ölümle ve gaiplik kararıyla sona erer. Ölümün yanında kişiliğin bitişini belirleyen iki önemli hukuki durum vardır:\\n  * Ölüm Karinesi: Ölümüne kesin gözle bakılmayı gerektiren durumlar içinde kaybolan ve cesedi bulunamayan kişinin hukuken ölmüş kabul edilmesidir. Karar en büyük mülki amir tarafından verilir, mahkeme kararı aranmaz.\\n  * Gaiplik: Ölüm tehlikesi içinde kaybolan veya kendisinden uzun süreden beri haber alınamayan ve ölme ihtimali yüksek olan kişilerin mahkeme kararıyla (Sulh Hukuk Mahkemesi) hukuken ölmüş sayılmasıdır.\\n  * Gaiplik Başvuru Süreleri: Ölüm tehlikesi içinde kaybolmada olaydan itibaren 1 yıl geçmesi gerekir. Uzun süre haber alamamada son haber alma tarihinden itibaren 5 yıl geçmesi gerekir. Evlilik ise gaiplik kararıyla kendiliğinden düşmez, eşin mahkemeden evliliğin feshini istemesi gerekir.\\n\\nTüzel Kişiler (Özel Hukuk Tüzel Kişileri):\\n- Dernekler: En az 7 gerçek veya tüzel kişinin kazanç paylaşma dışındaki ortak bir amacı gerçekleştirmek üzere bilgi ve çalışmalarını sürekli olarak birleştirmeleriyle kurulan kişi topluluklarıdır. Dernekler izin almadan, kuruluş bildirimini mülki amirliğe verdikleri an tüzel kişilik kazanırlar.\\n- Vakıflar: Başlı başına bağımsız bir varlığı olan, belirli ve sürekli bir amaca özgülenmiş mal topluluklarıdır. Vakıflar tek kişiyle kurulabilir. Vakıf kurma iradesi noter senediyle veya vasiyetname ile beyan edilir. Asliye Hukuk Mahkemesi nezdindeki sicile tescille tüzel kişilik kazanır.",
    "keyFacts": [
      "Ölüm karinesinde mülki amir kararı yeterlidir; gaiplikte ise Sulh Hukuk Mahkemesi kararı şarttır.",
      "Gaiplikte ölüm tehlikesi halinde 1 yıl, haber alamama halinde 5 yıl bekledikten sonra mahkemeye başvurulur.",
      "Dernekler kişi topluluğudur ve en az 7 kişiyle izin almadan kurulur; Vakıflar ise mal topluluğudur ve tek kişiyle de kurulabilir.",
      "Gaiplik kararı evliliği kendiliğinden sona erdirmez; eşin ayrıca evliliğin feshini talep etmesi şarttır."
    ],
    "examImportance": "Ölüm karinesi ile gaiplik farkları, gaiplik başvuru süreleri (1 yıl tehlike, 5 yıl haber alamama) ile derneklerin en az kaç kişiyle (7 kişi) ve ne zaman kurulduğu bilgileri sınavlarda doğrudan soru olarak karşımıza çıkar."
  }
];
`;
...
export const osmanliSiyasiData: EncyclopediaEntry[] = [
  {
    "id": "devlet-bicimleri-ve-hukumet-sistemleri",
    "category": "Anayasa Tarihi ve Devlet",
    "title": "Devlet Biçimleri ve Hükümet Sistemleri",
    "aliases": [
      "devlet sekilleri", "hukumet sistemleri", "uniter devlet", "federal devlet", "baskanlik", "parlamenter", "yari baskanlik"
    ],
    "keywords": [
      "devlet", "üniter", "federal", "başkanlık", "parlamenter", "teokrasi", "monarşi", "cumhuriyet"
    ],
    "shortDefinition": "Devletlerin hukuki yapılarına, egemenliğin kaynağına göre örgütlenme biçimlerine ve yasama-yürütme ilişkilerine göre sistemleridir.",
    "detailedExplanation": "Hukukta devletler yapılarına, egemenliğin kaynağına ve kuvvetler (yasama-yürütme) arasındaki ilişkilere göre çeşitli şekillerde sınıflandırılır:\\n\\n1. Yapılarına Göre Devlet Şekilleri:\\n- Üniter Devlet: Devletin sınırları içinde tek bir yasama, tek bir yürütme ve tek bir yargı organının bulunduğu, ülkenin idari birimlerinin merkeze bağlı olduğu devlet şeklidir (örn: Türkiye, Fransa). Yasa yapma yetkisi sadece merkezi meclistedir.\\n- Federal Devlet: İki veya daha fazla devletin (eyaletin) ortak bir anayasa altında birleşerek dış ilişkilerde tek bir devlet (federasyon), iç ilişkilerde ise bağımsız eyaletler (federe devletler) olarak teşkilatlanmasıdır (örn: ABD, Almanya). Eyaletlerin kendi meclisleri, kanunları ve yargı organları bulunur.\\n- Konfederal Devlet: Bağımsız devletlerin ortak çıkarlarını korumak üzere bir andlaşmayla kurdukları gevşek işbirliği birliğidir. Günümüzde tam örneği kalmamıştır.\\n\\n2. Egemenliğin Kaynağına Göre Devlet Şekilleri:\\n- Monarşi: Egemenliğin tek bir kişinin elinde bulunduğu ve genellikle babadan oğula geçtiği yönetim şeklidir. Mutlak monarşi ve Meşruti monarşi (hükümdarın yanında meclis ve anayasa bulunur) olarak ayrılır.\\n- Oligarşi: Egemenliğin belirli bir zümrenin, sınıfın veya grubun elinde bulunduğu devlet şeklidir.\\n- Teokrasi: Devlet yönetiminin dini kurallara dayandığı ve egemenliğin Tanrı adına din adamları sınıfınca kullanıldığı devlet şeklidir.\\n- Cumhuriyet: Egemenliğin bir şahsa veya gruba değil, millete ait olduğu ve yöneticilerin seçimle göreve geldiği devlet şeklidir.\\n\\n3. Hükümet Sistemleri (Kuvvetler İlişkisine Göre):\\n- Kuvvetler Birliği Sistemleri: Yasama ve yürütmenin tek bir organda toplanmasıdır. Meclis Hükümeti Sistemi (yasama ve yürütme meclistedir, örn: 1921 Anayasası dönemi), Mutlak Monarşi (yetkiler hükümdarda) bu gruba girer.\\n- Kuvvetler Ayrılığı Sistemleri:\\n  * Parlamenter Sistem: Yasama ve yürütmenin yumuşak ayrılığına dayanır. Yürütme çift başlıdır (Cumhurbaşkanı/Kral - sorumsuz baş; Bakanlar Kurulu - icracı baş). Cumhurbaşkanı tarafsızdır. Hükümet meclise karşı sorumludur, meclis hükümeti düşürebilir (gensoru ile).\\n  * Başkanlık Sistemi: Yasama ve yürütmenin sert ayrılığına dayanır. Yürütme tek başlıdır (sadece Başkan vardır, bakanlar sekreter gibidir). Başkan halk tarafından seçilir. Yasama ve yürütme birbirinin görevine son veremez. Aynı kişi hem mecliste hem yürütmede yer alamaz.\\n  * Yarı Başkanlık Sistemi: Cumhurbaşkanının halk tarafından seçildiği, yürütmenin çift başlı olduğu (hem güçlü bir Cumhurbaşkanı hem de meclise karşı sorumlu bir başbakan/hükümet bulunur) karma sistemdir (örn: Fransa).",
    "keyFacts": [
      "Üniter devlette tek anayasa, tek meclis ve tek yargı vardır; federal devlette ise eyaletlerin kendi anayasası ve meclisleri bulunur.",
      "Parlamenter sistemde yürütme çift başlıdır (tarafsız CB ve sorumlu Bakanlar Kurulu); Başkanlık sisteminde ise tek başlıdır (sadece Başkan).",
      "Kuvvetlerin sert ayrılığı Başkanlık sistemine; yumuşak ayrılığı ise Parlamenter sisteme aittir.",
      "Meclis Hükümeti Sistemi, kuvvetler birliğinin meclis lehine gerçekleştiği sistemdir."
    ],
    "examImportance": "Üniter ve federal devlet özellikleri, hükümet sistemleri arasındaki farklar (özellikle parlamenter sistem ile başkanlık sisteminin yürütme yapısı ve kuvvetler ayrılığı derecesi) KPSS sınavında çok sık sorulan temel kavramlardandır."
  },
  {
    ...
    "keyFacts": [
      ...
      "Çift meclisli parlamenter yapıya sahiptir: Meclis-i Mebusan (seçimle gelen) ve Meclis-i Ayan (atama ile gelen).",
  ...
  },
  {
    "id": "anayasa-1924",
    "category": "Anayasa Tarihi ve Devlet",
    "title": "1924 Anayasası ve Laikleşme Aşamaları",
    "aliases": [
      "1924 anayasası", "karma hukumet", "sert anayasa", "laiklesme", "1924", "1937"
    ],
    "keywords": [
      "anayasa", "laiklik", "çoğunlukçu", "sert", "kazuistik", "1924", "seçim"
    ],
    "shortDefinition": "Yeni kurulan Türk Devleti'nin ilk olağan anayasası olup meclis hükümeti ile parlamenter sistemi harmanlayan karma bir hükümet sistemini benimsemiştir.",
    "detailedExplanation": "20 Nisan 1924 tarihinde kabul edilen bu anayasa, Cumhuriyet döneminin ilk olağan ve yeni devletin düzenini kuran temel belgedir. 1961 yılına kadar en uzun süre yürürlükte kalan anayasamız olmuştur.\\n\\nTemel Özellikleri ve Sistemi:\\n- Karma Hükümet Sistemi: Yasama ve yürütme yetkileri yine mecliste toplanmıştır (kuvvetler birliği) ancak yürütme yetkisi meclisin seçtiği Cumhurbaşkanı ve Bakanlar Kurulu eliyle kullanılır (görevler ayrılığı). Yani meclis hükümeti ile parlamenter sistem arasında geçiş niteliğindedir.\\n- Sert ve Kazuistik Yapı: Değiştirilemez ilk maddesi (Devletin bir Cumhuriyet olduğu hükmü) nedeniyle ilk kez sert/katı anayasa özelliği kazanmıştır. Ayrıca 1921'e kıyasla çok daha detaylıdır.\\n- Çoğunlukçu Demokrasi: Seçimi kazanan grubun mecliste mutlak hakimiyetini savunan çoğunlukçu anlayışı benimsemiştir. Tek meclisli sistemi korumuştur.\\n- Haklar: Temel hak ve hürriyetleri 'doğal hak' anlayışıyla düzenlemiştir ancak sosyal ve ekonomik haklara yer vermemiştir.\\n\\nAnayasanın Laikleşme Aşamaları ve Önemli Değişiklikleri:\\n- 1928 Değişikliği: 'Devletin dini İslam'dır' ibaresi anayasadan çıkarılmış, milletvekili yemin şeklindeki dini ifadeler değiştirilmiştir.\\n- 1934 Değişikliği: Kadınlara ilk kez milletvekili seçme ve seçilme hakkı verilmiştir.\\n- 1937 Değişikliği: Atatürk ilkeleri (Laiklik dahil 6 temel ilke) anayasa metnine eklenmiştir. Böylece devlet hukuken tamamen laikleşmiştir.\\n- 1945 Değişikliği: Anayasanın dili Türkçeleştirilmiştir.\\n- 1946 Değişikliği: İlk kez çok partili genel seçimler yapılmıştır (Tek dereceli seçim sistemine ise 1950'de geçilmiştir).",
    "keyFacts": [
      "Cumhuriyet döneminin ilk sert ve kazuistik anayasasıdır; değiştirilemeyecek tek maddesi 1. maddedir (Cumhuriyet).",
      "Kuvvetler birliği ve görevler ayrılığı ilkesini benimseyen 'karma hükümet' sistemini kurmuştur.",
      "Devletin dini İslam'dır ibaresi 1928'de çıkarılmış, Laiklik ilkesi ise anayasaya 1937'de girmiştir.",
      "Kadınlara milletvekili seçme ve seçilme hakkı 1934 değişikliğiyle anayasal güvenceye kavuşmuştur."
    ],
    "examImportance": "1924 Anayasası'nın karma hükümet yapısı, laikleşme adımlarının yılları (1928 din ibaresinin kalkması, 1937 ilkelerin eklenmesi), kadınların siyasi hakları kazanma sıralaması (Belediye 1930, Muhtar 1933, Milletvekili 1934) KPSS vatandaşlık anayasa tarihi bölümünün en popüler soru şablonlarıdır."
  },
  {
    "id": "anayasa-1961",
    "category": "Anayasa Tarihi ve Devlet",
...
export const osmanliKulturMedeniyetData: EncyclopediaEntry[] = [
  {
    "id": "milletvekili-secilme-sartlari-surecleri",
    "category": "Yasama",
    "title": "Milletvekili Seçilme Şartları ve Seçim Süreçleri",
    "aliases": [
      "milletvekili secilme", "mv sartlari", "mv yasi", "secimlerin geriye birakilmasi", "ara secim", "erken secim"
    ],
    "keywords": [
      "milletvekili", "seçilme", "seçim", "yaş", "erken", "ara", "erteleme", "18"
    ],
    "shortDefinition": "Anayasa'ya göre TBMM milletvekili adayı olabilmek için gereken şartlar ile seçimlerin yapılması, ertelenmesi ve yenilenmesi kurallarıdır.",
    "detailedExplanation": "TBMM milletvekilliği adaylığı ve seçim süreçleri anayasanın yasama bölümünde detaylı şekilde düzenlenmiştir. Seçimler 5 yılda bir yapılır ve milletvekili sayısı 600'dür.\\n\\nMilletvekili Seçilebilme Şartları (Md. 76):\\n- 18 yaşını doldurmuş olmak (2017 değişikliğiyle yaş sınırı 25'ten 18'e düşürülmüştür).\\n- En az ilkokul mezunu olmak.\\n- Askerlikle ilişiği bulunmamak (askerliğini yapmış olmak şart değildir, ilişiği olmaması yeterlidir).\\n- Kamu hizmetlerinden yasaklı olmamak.\\n- Taksirli suçlar hariç, toplam 1 yıl veya daha fazla hapis ya da ağır hapis cezasına hüküm giymemiş olmak.\\n- Zimmet, ihtilas, irtikap, rüşvet, hırsızlık, dolandırıcılık, sahtecilik, inancı kötüye kullanma, dolanlı iflas gibi yüz kızartıcı suçlardan mahkum olmamak (bu suçlardan mahkum olanlar affa uğramış olsalar bile milletvekili seçilemezler).\\n- Aday olabilmek için görevinden çekilmesi gerekenler: Hakimler ve savcılar, yüksek yargı organı mensupları, üniversite öğretim üyeleri, YÖK üyeleri, kamu görevlileri (memurlar) ve TSK mensuplarıdır. (Hakimler, savcılar ve TSK mensupları seçilemezlerse görevlerine geri dönemezler; memurlar ve öğretim üyeleri dönebilir).\\n\\nSeçimlerin Ertelenmesi (Geriye Bırakılması):\\n- Seçimler anayasaya göre yalnızca 'Savaş' sebebiyle ertelenebilir. Erteleme kararı TBMM tarafından 1 yıl süreyle verilir. Savaş durumu devam ederse erteleme işlemi her defasında 1 yıl olmak üzere tekrarlanabilir. Savaş dışında hiçbir sebeple (afet, salgın vb.) seçimler ertelenemez.\\n\\nAra Seçim (İstisnai Seçim):\\n- İki genel seçim arasında boşalan milletvekillikleri için yapılan kısmi seçimdir. Kural olarak genel seçimlerden 30 ay geçmedikçe ara seçime gidilemez ve genel seçimlere 1 yıl kala ara seçim yapılamaz. Ancak iki istisnası vardır:\\n  * Boşalan üye sayısı meclis üye tamsayısının %5'ine (30 milletvekili) ulaşırsa, ara seçimlerin 3 ay içinde yapılması zorunludur (genel seçimlere 1 yıl kala yine de yapılamaz).\\n  * Bir ilin veya seçim çevresinin mecliste hiç temsilcisinin kalmaması durumunda, boşalmayı takip eden 90 günden sonraki ilk pazar günü ara seçim yapılması zorunludur.",
    "keyFacts": [
      "Milletvekili seçilme yaşı 18'dir; askerlikten muaf veya tecilli olanlar da aday olabilir.",
      "Yüz kızartıcı suçlardan mahkum olanlar genel affa uğrasalar bile hiçbir zaman milletvekili olamazlar.",
      "Seçimler sadece savaş sebebiyle ve yalnızca TBMM kararıyla en fazla 1 yıl ertelenebilir.",
      "Bir seçim çevresinde hiç milletvekili kalmazsa 90 gün sonra ara seçim yapılması zorunludur; bu durumda 1 yıllık yasak süre uygulanmaz."
    ],
    "examImportance": "Seçilme şartlarındaki yaş (18), eğitim (ilkokul) ve askerlik detayı ile seçim erteleme sebebi (sadece savaş, 1 yıl) ve ara seçim istisnaları (temsilcinin kalmaması durumu) KPSS sınavlarında çok sık sorulan seçici bilgilerdir."
  },
  {
    "id": "tbmm-toplanti-ve-karar-yeter-sayilari",
    "category": "Yasama",
    "title": "TBMM Toplantı ve Karar Yeter Sayıları",
    "aliases": [
      "toplanti yeter sayisi", "karar yeter sayisi", "nitelikli cogunluk", "meclis karar sayilari", "anayasa degisikligi oy orani"
    ],
    "keywords": [
      "tbmm", "toplantı", "karar", "nitelikli", "çoğunluk", "151", "200", "360", "400"
    ],
    "shortDefinition": "Meclisin genel kurulda toplanabilmesi, karar alabilmesi ve anayasa değişikliği yapabilmesi için anayasanın aradığı üye sayılarıdır.",
    "detailedExplanation": "TBMM çalışmalarını düzenli yürütebilmek ve keyfi kararları önlemek amacıyla anayasada toplantı ve karar süreçleri için kesin sınırlar ve nitelikli oy oranları belirlenmiştir. TBMM üye tamsayısı 600'dür.\\n\\n1. Toplantı Yeter Sayısı:\\n- TBMM'nin Genel Kurul salonunda toplanıp çalışmaya başlayabilmesi için üye tamsayısının en az 1/3'ünün (yani en az 200 milletvekilinin) salonda hazır bulunması şarttır. Toplantı başında veya oylamalarda 200 vekil bulunmadığı iddia edilirse yoklama yapılır; yoklama sonucu 200 vekil yoksa meclis birleşimi kapatır.\\n\\n2. Karar Yeter Sayısı:\\n- TBMM, anayasada aksine özel bir hüküm bulunmayan tüm durumlarda toplantıya katılan milletvekillerinin salt çoğunluğu ile karar verir.\\n- Ancak anayasa karar yeter sayısı için asgari bir sınır çizmiştir: Karar yeter sayısı hiçbir şekilde üye tamsayısının 1/4'ünün 1 fazlasından az olamaz (yani salonda kaç kişi olursa olsun en az 151 kabul oyu bulunmalıdır).\\n\\n3. Nitelikli Çoğunluk Gerektiren Başlıca Kararlar ve Oy Oranları:\\n- Üye tamsayısının salt çoğunluğu (301 Milletvekili):\\n  * TBMM Başkanı seçimi (3. turda aranan oy oranı).\\n  * Kamu Başdenetçisi seçimi (3. turda aranan oy oranı).\\n  * Meclis soruşturması açılması önergesi teklif sayısı.\\n- Üye tamsayısının 3/5 çoğunluğu (360 Milletvekili):\\n  * Genel ve özel af ilanı kararı.\\n  * Anayasa değişikliğinin kabul edilmesi (Cumhurbaşkanı referanduma sunabilir veya onaylayabilir).\\n  * Seçimlerin meclis tarafından yenilenmesi (erken seçim kararı).\\n  * Meclis soruşturması açılması kararı (gizli oylamayla).\\n  * Anayasa Mahkemesi veya HSK üye seçimi (2. turda aranan oy oranı).\\n- Üye tamsayısının 2/3 çoğunluğu (400 Milletvekili):\\n  * Anayasa değişikliğinin referumsuz kabulü.\\n  * Cumhurbaşkanı, yardımcıları veya bakanların Yüce Divan'a sevk edilmesi kararı (gizli oylamayla).\\n  * TBMM Başkanı ve Kamu Başdenetçisi seçimi (1. ve 2. turda aranan oy oranı).",
    "keyFacts": [
      "Toplantı yeter sayısı üye tamsayısının 1/3'üdür (200 milletvekili).",
      "Karar yeter sayısı en az 151 milletvekilidir; bu sayı 1/4'ün 1 fazlasına karşılık gelir.",
      "Erken seçim kararı, af ilanı ve meclis soruşturması açılması için 360 vekil (3/5) oyu gerekir.",
      "Yüce Divan'a sevk kararı için üye tamsayısının 2/3'ü olan 400 vekil oyu şarttır."
    ],
    "examImportance": "Toplantı (200) ve asgari karar yeter sayısı (151) ile nitelikli kararların oy oranları (301, 360, 400) vatandaşlık anayasa hukuku testlerindeki en zorlayıcı sayısal soruların başında gelmektedir."
  },
  {
  ...
  },
  {
    ...
    "keyFacts": [
      ...
      "Meclis soruşturması açılması için sırasıyla 301 teklif, 360 soruşturma açma kararı ve 400 Yüce Divan'a sevk kararı oyu gereklidir.",
...
export const inkilapTarihiData: EncyclopediaEntry[] = [
  {
    ...
    "detailedExplanation": "2017 Anayasa değişiklikleriyle Bakanlar Kurulu kaldırılmış, Başbakanlık makamı son bulmuş ve yürütme yetkisi tek başına Cumhurbaşkanı'na verilmiştir. Böylece yürütme organı tek başlı haline gelmiştir.\\n\\nCumhurbaşkanı Seçimi ve Şartları:\\n- Halk tarafından doğrudan seçilir. Seçim süresi 5 yıldır. Bir kişi en fazla iki defa Cumhurbaşkanı seçilebilir.\\n- Seçilebilme Şartları: Türk vatandaşı olmak, 40 yaşını doldurmuş olmak, yükseköğrenim mezunu olmak ve milletvekili seçilme yeterliliğine sahip olmak.\\n- Aday Gösterme Yetkisi: Siyasi parti grupları, en son yapılan genel seçimlerde tek başına veya birlikte en az %5 oy almış olan partiler veya en az 100 bin seçmen imza ile aday gösterebilir.\\n\\nBaşlıca Görev ve Yetkileri:\\n- Devletin başı sıfatıyla Türkiye Cumhuriyeti'ni ve Türk Milletinin birliğini temsil eder; Anayasanın uygulanmasını gözetir.\\n- Kanunları yayımlar veya yayımlanmasını uygun bulmadığı kanunları gerekçesiyle birlikte meclise geri gönderir.\\n- Cumhurbaşkanı yardımcılarını ve bakanları atar, görevlerine son verir.\\n- Üst düzey kamu yöneticilerini atar ve görevden alır.\\n- Yabancı devletlere temsilci gönderir ve yabancı elçileri kabul eder.\\n- Milletlerarası andlaşmaları onaylar ve yayımlar.\\n- TSK'nın başkomutanlığını temsil eder; TSK'nın kullanılmasına karar verir.\\n- Olağanüstü Hal (OHAL) ilan eder ve Resmi Gazete'de yayımlayıp meclis onayına sunar.\\n- Anayasa değişikliklerine ilişkin kanunları gerekli gördüğünde halkoyuna sunar.\\n- Anayasa Mahkemesi'ne kanunların veya CB kararnamelerinin iptali için dava açar.",
    "keyFacts": [
      "Yürütme yetkisi tek başına Cumhurbaşkanı'na aittir; Başbakanlık ve Bakanlar Kurulu kaldırılmıştır.",
      "CB seçilmek için yaş sınırı 40'tır ve lisans mezunu olmak zorunludur.",
      "Bir kişi en fazla 2 kez seçilebilir; ancak 2. döneminde meclis seçimleri yenilerse 3. kez aday olabilir.",
      "TBMM veto edilen bir kanunu üye tamsayısının salt çoğunluğu ile aynen kabul ederse, CB bunu onaylamak zorundadır."
    ],
  ...
  },
  {
    ...
    "keyFacts": [
      ...
      "OHAL CBK'leri aleyhine Anayasa Mahkemesi'ne iptal davası açılamaz.",
      "OHAL CBK'leri ile sosyal, ekonomik ve siyasi hakların yanı sıra kişisel haklar da sınırlandırılabilir."
    ],
    "examImportance": "OHAL ilan makamı (CB) ve maksimum ilan süresi (6 ay), meclisin uzatma süresi (max 4 ay) ve yetkileri ile OHAL kararnamelerinin yargı denetimi dışı olması ve normal kararnamelerden farkları KPSS'de çok popüler ve ayırt edici sorulardır."
  },
  {
    ...
    "keyFacts": [
      ...
      "Yargı organları DDK'nın yetki alanı dışındaki tek istisnadır.",
  ...
  {
    "id": "cumhurbaskanligi-kararnameleri-cbk",
    "category": "Yürütme",
    "title": "Cumhurbaşkanlığı Kararnameleri (CBK) ve Kuralları",
    "aliases": [
      "cbk", "kararnameler", "olagan cbk", "olaganustu cbk", "cbk farklari"
    ],
    "keywords": [
      "kararname", "cbk", "olağan", "olağanüstü", "anayasa", "aym", "yargı"
    ],
    "shortDefinition": "Cumhurbaşkanı'nın yürütme yetkisine ilişkin olarak çıkardığı, olağan ve olağanüstü dönem kararnameleri olarak ikiye ayrılan anayasal düzenleyici işlemlerdir.",
    "detailedExplanation": "Cumhurbaşkanlığı Kararnameleri (CBK), 2017 anayasa değişikliği ile Türk hukuk sistemine girmiştir. Yürütmenin asli düzenleme yetkisinin en önemli aracıdır. Olağan Dönem CBK'ları ve Olağanüstü Dönem (OHAL) CBK'ları olmak üzere iki ayrı hukuki rejime tabidirler:\\n\\n1. Olağan Dönem Cumhurbaşkanlığı Kararnameleri:\\n- Sadece yürütme yetkisine ilişkin konularda çıkarılabilir.\\n- Anayasadaki temel haklar, kişi hakları ve ödevleri ile siyasi haklar ve ödevler CBK ile düzenlenemez (Yalnızca Sosyal ve Ekonomik Haklar düzenlenebilir).\\n- Anayasada açıkça kanunla düzenlenmesi öngörülen konularda CBK çıkarılamaz.\\n- Kanunda açıkça düzenlenen konularda CBK çıkarılamaz. Eğer kanun hükmü ile CBK hükmü çelişirse, Kanun hükmü uygulanır.\\n- TBMM aynı konuda kanun çıkarırsa, CBK hükümsüz kalır.\\n- Yargısal Denetimi: Anayasa Mahkemesi tarafından denetlenir.\\n\\n2. Olağanüstü Dönem (OHAL) Cumhurbaşkanlığı Kararnameleri:\\n- Sadece olağanüstü hal dönemlerinde ve OHAL'in gerekli kıldığı konularda çıkarılabilir.\\n- Anayasadaki temel haklar, kişi hakları ve siyasi haklar dahil olmak üzere (çekirdek haklar hariç) tüm haklar sınırlandırılabilir veya askıya alınabilir.\\n- Kanunla düzenleme sınırı veya kanun-kararname çelişmesinde kanunun üstünlüğü kuralı bu kararnameler için geçerli değildir.\\n- Yargısal Denetimi: Anayasa gereği OHAL kararnameleri aleyhine AYM'ye dava açılamaz, yargı yolu tamamen kapalıdır (Resmi Gazete'de yayımlandığı gün meclise sunulurlar; meclis 3 ay içinde onaylamazsa yürürlükten kalkarlar).",
    "keyFacts": [
      "Olağan CBK ile sadece sosyal ve ekonomik haklar düzenlenebilir; OHAL CBK ile çekirdek haklar hariç tüm haklar sınırlandırılabilir.",
      "Olağan CBK'nın kanunla çelişmesi durumunda kanun üstün kabul edilir; meclis kanun çıkarırsa CBK hükümsüz kalır.",
      "Olağan CBK'lar AYM denetimine tabidir; OHAL CBK'lar hakkında ise AYM'ye dava açılamaz.",
      "OHAL CBK'larının yayımlandıkları gün meclise sunulması zorunludur; meclis 3 ay içinde onaylamazsa kararname kendiliğinden düşer."
    ],
    "examImportance": "Olağan CBK ile düzenlenen haklar (sosyal/ekonomik) ve düzenlenemeyenler (kişisel/siyasi), kanunla çelişme durumu (kanunun üstünlüğü) ile OHAL CBK'larının yargı denetimi dışı olması özellikleri KPSS'nin en çok sorduğu yürütme hukuku sorularındandır."
  }
];
`;
...
export const cagdasTarihData: EncyclopediaEntry[] = [
  {
    ...
    "keyFacts": [
      ...
      "Bireysel başvurular için tüm iç hukuk yollarının tüketilmiş olması şarttır.",
  ...
  },
  {
    ...
    "keyFacts": [
      ...
      "Askeri Yargıtay ve AYİM 2017 yılında tamamen kaldırılmıştır; ülkede askeri mahkeme kalmamıştır.",
  ...
  },
  {
    ...
    "keyFacts": [
      ...
      "HSK kararlarına karşı genel kural olarak yargı yolu kapalıdır. Tek istisnası 'meslekten çıkarma' cezası kararlarıdır; bu kararlara karşı yargı yoluna başvurulabilir."
    ],
...
export const anlasmalarSavaslarData: EncyclopediaEntry[] = [
  ...
  },
  {
    ...
    "examImportance": "Memurluğun temel ilkeleri (Sınıflandırma, Kariyer, Liyakat), disiplin cezalarının tam listesi (uyarma, kınama, aylıktan kesme, kademe durdurma, çıkarma) ve disiplin cezalarının tamamına yargı yolunun açık olduğu bilgisi KPSS'de çok sık sorulur."
  },
  {
    "id": "devlet-idari-teskilat-yapisi",
    "category": "İdare Hukuku",
    "title": "Devlet İdari Teşkilat Şeması ve Birimleri",
    "aliases": [
      "idari teskilat", "idare semasi", "merkezden yonetim", "yerinden yonetim", "tasra teskilati", "baskent"
    ],
    "keywords": [
      "teşkilat", "şema", "merkez", "taşra", "başkent", "yerinden", "hizmet"
    ],
    "shortDefinition": "Türkiye Cumhuriyeti idaresinin anayasal olarak merkezden yönetim (başkent ve taşra) ve yerinden yönetim (mahalli ve hizmet) olarak yapılanmasıdır.",
    "detailedExplanation": "Türkiye Cumhuriyeti idari teşkilat yapısı, anayasanın 123. maddesindeki 'İdare, kuruluş ve görevleriyle bir bütündür ve kanunla düzenlenir' esasına dayanır. Teşkilat iki ana başlıkta kurulmuştur:\\n\\n1. Merkezden Yönetim (Devlet Tüzel Kişiliği):\\n- Başkent Teşkilatı: İdarenin karar merkezidir. Cumhurbaşkanı, Cumhurbaşkanı Yardımcıları, Bakanlıklar ve Başkente yardımcı kuruluşlar (Milli Güvenlik Kurulu-MGK, Devlet Denetleme Kurulu-DDK, Danıştay, Sayıştay) bu gruptadır.\\n- Taşra Teşkilatı: Başkentteki kararları ülkenin diğer bölgelerinde uygulayan organlardır. Kamu tüzel kişilikleri yoktur, doğrudan devlet tüzel kişiliğine bağlıdırlar. Üç birimden oluşur:\\n  * İl Genel Yönetimi: Vali (atama ile gelir, yetki genişliğine sahiptir), İl İdare Şube Başkanları, İl İdare Kurulu.\\n  * İlçe Yönetimi: Kaymakam (atama ile gelir, yetki genişliği yoktur), İlçe İdare Şube Başkanları, İlçe İdare Kurulu.\\n  * Bucak Yönetimi: Bucak Müdürü, Bucak Meclisi, Bucak Komisyonu (Günümüzde fiilen kaldırılmıştır).\\n\\n2. Yerinden Yönetim (Devlet Dışındaki Kamu Tüzel Kişilikleri):\\n- Mahalli İdareler (Yerel Yönetimler): Karar organları yerel halk tarafından seçilen birimlerdir. İl Özel İdaresi, Belediye, Büyükşehir Belediyesi ve Köy bu gruptadır.\\n- Hizmet Yerinden Yönetim Kuruluşları (Kamu Kurumları): Belirli bir teknik, bilimsel veya kültürel hizmeti yürütmek üzere kurulan, özerk bütçeli kuruluşlardır. Dört grupta toplanır:\\n  * İdari Kamu Kurumları: Orman Genel Müdürlüğü, Karayolları Genel Müdürlüğü vb.\\n  * İktisadi Kamu Kurumları (KİT'ler): TCDD, Ziraat Bankası, ÇAYKUR vb.\\n  * Sosyal Kamu Kurumları: SGK, Türkiye İş Kurumu (İŞKUR) vb.\\n  * Bilimsel, Teknik, Kültürel Kamu Kurumları: TÜBİTAK, TRT, Üniversiteler vb.\\n  * Kamu Kurumu Niteliğindeki Meslek Kuruluşları: Barolar, Ticaret Odaları, Tabipler Birliği vb. (Kamu tüzel kişilikleri anayasa tarafından tanınmıştır).",
    "keyFacts": [
      "Taşra teşkilatının kendine ait bütçesi ve kamu tüzel kişiliği yoktur; harcamaları devlet bütçesinden yapılır.",
      "Vali, taşrada 'yetki genişliği' yetkisine sahip tek makamdır; kaymakamın yetki genişliği yoktur.",
      "Hizmet yerinden yönetim kuruluşlarının tamamının kendine ait ayrı kamu tüzel kişiliği ve bütçesi vardır.",
      "MGK, DDK, Sayıştay ve Danıştay başkente yardımcı kurullardır; YÖK ve TRT ise hizmet yerinden yönetim kuruluşudur."
    ],
    "examImportance": "İdari teşkilat şeması soruları (Valiliğin veya Kaymakamlığın nerede yer aldığı - Taşra teşkilatı), yetki genişliğinin sadece Valiye ait olduğu ve kamu tüzel kişiliği olanlar ile olmayanlar (Bakanlıkların tüzel kişiliği yoktur, belediyenin vardır) ayrımı KPSS idare hukuku testlerinin en popüler ve kilit konularıdır."
  }
];
`;
...
console.log("All 7 encyclopedia files successfully expanded to 100x content size!");
